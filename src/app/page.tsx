      ...
      <section className="relative h-[60vh] bg-cover bg-center" style={{ backgroundImage: "url('https://picsum.photos/1200/800?school')" }}>
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/50 to-transparent flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Selamat Datang di SMP ISLAM HEGARMANAH</h1>
            <p className="text-lg md:text-xl mb-8">Membentuk Generasi Qur'ani, Cerdas, dan Berakhlak Mulia</p>
            <Link href="/penerimaan" className="bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 px-6 rounded-lg">
              Info Penerimaan
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <Link href="#" className="text-teal-600 hover:underline">Baca Selengkapnya</Link>
              </div>
            </div>
            {/* News Card 2 */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-xl">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white p-4 rounded-lg shadow-md mb-4 flex items-center">
              <div className="bg-teal-600 text-white text-center rounded-lg p-3">
