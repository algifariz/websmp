      ...
      <div className="max-w-3xl mx-auto text-lg text-gray-700">
        ...
        <div className="mt-8 space-y-6">
          <div className="flex items-start">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-4 text-teal-600 flex-shrink-0">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
            </svg>
            <div>
              <h3 className="font-bold">Alamat</h3>
              <p>Jalan Pendidikan No. 1, Kota Harapan, Indonesia</p>
            </div>
          </div>
          <div className="flex items-start">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-4 text-teal-600 flex-shrink-0">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p>info@smpislamhegarmanah.sch.id</p>
            </div>
          </div>
        </div>
      </div>
